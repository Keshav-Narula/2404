...
int main()
{
  ...
  //Complier is fine with the Animal reference, even though its an abstract type you can declare refernces of that type just cant declare oobjects of that type
