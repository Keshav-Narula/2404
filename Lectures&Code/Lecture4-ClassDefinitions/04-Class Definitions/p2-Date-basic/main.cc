...
int main()
{
  ...
  Date d1(2020, 9, 9);
  Date d2; //Statically allocated not using the new keyword Stored on the stack frame, dont have to manage that piece of memory
  ...
  Date* arr[MAX_SIZE]; //Statically Array of Date object pointers, assignment 1 
  arr[0] = new Date();
